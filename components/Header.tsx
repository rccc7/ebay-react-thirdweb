		...
		<div className='max-w-6xl mx-auto p-2'>
			...
			<nav className='flex justify-between'>
				...
				<div className='flex items-center space-x-4 text-sm'>
					...
					<Link className='flex items-center link' href={'/addItem'}>
						Add to inventory
			...
			<section className='flex items-center space-x-2 py-5'>
				<div className='h-16 w-16 sm:w-28 md:w-44 cursor-pointer flex-shrink-0'>
					...
					// attributions='https://commons.wikimedia.org/wiki/File:EBay_logo.svg'
					width={100}
					height={100}
					/>
					</Link>
				...
				<div className='flex items-center space-x-2 px-2 md:px-5 py-2 border-black
				border-2 flex-1'>
